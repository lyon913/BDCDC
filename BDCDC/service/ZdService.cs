...
namespace BDCDC.service
{
    ...
    class ZdService:Service
    {
         ...
         * 
         * */
        public String getMaxZdsxh(String djzq, BdcContext ctx)
        {
            //宗地代码编制规则：
        ...
        public String getMaxDzwsxh(String zddm, String dzwtzm, BdcContext ctx)
        {
            if ("W".Equals(dzwtzm))
            {
                //使用权宗地无定着物
         ...
         * 
         * */
        public List<DJZQ> getDjzqAll(BdcContext ctx)
        {
